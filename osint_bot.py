#!/usr/bin/env python3
# OSINT BOT v8.2 — PROFI ULTIMATE (FIXED GROQ MODEL)
...
def admin_panel(message):
    ...
    markup.add(types.InlineKeyboardButton("🗑 Очистить историю", callback_data="clear_all"))
...
def admin_callback(call):
    ...
    if call.data == "stats":
        ...
        total = c.fetchone()[0]
        conn.close()
        bot.answer_callback_query(call.id, f"Всего запросов: {total}", show_alert=True)
